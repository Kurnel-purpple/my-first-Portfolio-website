...
const HPServices =()=>{
    return(
        ...
        <section className='flex flex-col'>
            ...
            <div className='flex'>
            <img src={serviceImg} alt="" className='h-fit top-14 relative' />
            <div className='px-3'>
            <h1 className='text-xl font-bold mb-2 text-stone-800'>Here's some ways we can bring your dreams alive</h1>
            <div className='sm:grid sm:grid-cols-2 gap-4 text-lg'>
                <div className='shadow-myShadow2 bg-pink-100/50 px-3 pt-2 pb-4 rounded-tr-[50px] rounded-bl-[20px]'>
