...
const HPServices =()=>{
    return(
        ...
        <section className='flex flex-col'>
            ...
            <img src={serviceImg} alt="" className='h-fit lg:top-14 relative rounded-r-full rounded-bl-full dark:mt-[100px]' />
            <div className='md:px-3 mb-4 z-10 flex flex-col my-auto'>
            ...
            <div className='flex flex-col sm:grid sm:grid-cols-2 gap-y-4 gap-4 text-lg'>
                <div className='shadow-myShadow2 dark:shadow-myShadow3 mx-auto bg-pink-100/50 dark:bg-stone-900/70 px-3 pt-2 pb-4 rounded-tr-[50px] rounded-bl-[20px]'>
                    <div className='bg-gradient-to-r from-mydarkblue2 via-green-400 to-violet-500 pb-1 rounded-tr-[50px] mx-2'>
                        <h4 className='font-bold text-mydarkblue2 bg-pink-100 dark:bg-stone-900 dark:text-white rounded-tr-[50px]' style={{fontFamily:'cursive'}} >Web Development</h4>
                    </div>
                ...
                <div className='shadow-myShadow2 dark:shadow-myShadow3 mx-auto bg-pink-100/50 dark:bg-stone-900/70 px-3 pt-2 pb-4 rounded-tr-[50px] rounded-bl-[20px]'>
                <div className='bg-gradient-to-r from-mydarkblue2 via-green-400 to-violet-500 pb-1 rounded-tr-[50px] mx-2'>
                        <h4 className='font-bold text-mydarkblue2 bg-pink-100 dark:bg-stone-900 dark:text-white rounded-tr-[50px]' style={{fontFamily:'cursive'}} >I.C.T Instruction</h4>
                    </div>
                ...
                <div className='shadow-myShadow2 dark:shadow-myShadow3 mx-auto bg-pink-100/50 dark:bg-stone-900/70 px-3 pt-2 pb-4 rounded-tr-[50px] rounded-bl-[20px]'>
                <div className='bg-gradient-to-r from-mydarkblue2 via-green-400 to-violet-500 pb-1 rounded-tr-[50px] mx-2'>
                        <h4 className='font-bold text-mydarkblue2 bg-pink-100 dark:bg-stone-900 dark:text-white rounded-tr-[50px]' style={{fontFamily:'cursive'}} >App Development</h4>
                    </div>
                ...
                <div className='shadow-myShadow2 dark:shadow-myShadow3 mx-auto bg-pink-100/50 dark:bg-stone-900/70 px-3 pt-2 pb-4 rounded-tr-[50px] rounded-bl-[20px]'>
                <div className='bg-gradient-to-r from-mydarkblue2 via-green-400 to-violet-500 pb-1 rounded-tr-[50px] mx-2'>
                        <h4 className='font-bold text-mydarkblue2 bg-pink-100 dark:bg-stone-900 dark:text-white rounded-tr-[50px]' style={{fontFamily:'cursive'}} >ERP Implementation</h4>
                    </div>
