        ...
        <div >
            ...
            <div className=' flex flex-col'>
                ...
                <div className='flex mx-auto my-[20px]  justify-between gap-6'>
                    <button className="bg-gradient-to-r shadow-myShadow2 text-wheat from-mywall to-stone-500 px-[20px] py-1 text-xl font-semibold rounded-3xl " ><NavLink to="/Contact">Reach Us</NavLink> </button>
