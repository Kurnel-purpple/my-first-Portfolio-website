            ...
            <div className='flex flex-col'>
                ...
                <div className='flex justify-between'>
                    <div className='flex flex-col justify-around w-[50%]'>
                        ...
                        <button className="bg-gradient-to-r shadow-myShadow2 text-wheat from-mywall to-stone-500 px-[20px] py-1 text-xl font-semibold rounded-3xl w-fit  mx-auto " ><NavLink to="/Skills">See More</NavLink> </button>
                    </div>
