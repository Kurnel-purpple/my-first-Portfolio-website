            ...
            <div className='flex flex-col px-4'>
                ...
                <div className='lg:flex justify-between '>
                    <div className='flex flex-col justify-around lg:w-[50%] mb-[20px] lg:mb-0'>
                        <div className='shadow-myShadow2 dark:shadow-myShadow3 my-2 flex py-3 px-2 flex-col'>
                            <h3 className='font-semibold mx-auto underline text-xl text-mydarkblue2 dark:text-gray-300' style={{fontFamily:'cursive'}}>Programing Languages</h3>
                        ...
                        <div className='shadow-myShadow2 dark:shadow-myShadow3 my-2 flex py-3 px-2 flex-col'>
                            <h3 className='font-semibold mx-auto underline text-xl text-mydarkblue2 dark:text-gray-300' style={{fontFamily:'cursive'}}>Low-Code Tools</h3>
                            <ul className='grid gap-4 list-disc px-4 font-semibold grid-cols-3'>
                                <li>Figma</li>
                                <li>Wix</li>
                                <li>Blogger</li>
