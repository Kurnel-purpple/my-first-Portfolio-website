    ...
    return(
        <div className='flex flex-col'>
            ...
            <div className='grid grid-cols-2 grid-rows-3 gap-3'>
                ...
                <div className='flex flex-col '>
                    <h3 className='font-bold mb-4 text-lg text-slate-700 cursor-pointer mx-auto ' style={{fontFamily:'cursive'}} >Phronema Eduction Consults official website</h3>
                    <div className='mx-auto w-[400px] h-[400px]'>
                ...
                <div className=' flex flex-col'>
                    <h3 className='font-bold mb-4 text-lg text-slate-700 cursor-pointer mx-auto ' style={{fontFamily:'cursive'}} >In-school I.C.T and computer science projects with students</h3>
                    <div className='mx-auto w-[400px] h-[400px]'>
                ...
                <div className=' flex flex-col'>
                    <h3 className='font-bold mb-4 text-lg text-slate-700 cursor-pointer  mx-auto ' style={{fontFamily:'cursive'}} >Scratch programming with students</h3>
                    <div className='mx-auto w-[400px] h-[400px]'>
                        <img className='rounded-full cursor-pointer' src={classroom2} alt="" />
                    </div>
                    <p></p>
                </div>
                <div className='col-span-2  flex flex-col'>
                    <h3 className='font-bold mb-4 text-lg text-slate-700 cursor-pointer mx-auto' style={{fontFamily:'cursive'}} >My Portfolio</h3>
                    <div className='mx-auto w-[400px] h-[400px]'>
