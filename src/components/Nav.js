    ...
    return(
        ...
        <>
            <header className=' flex flex-col pr-3 sm:pr-0 h-[5rem] bg-wheat pt-3 px-2 overflow-hidden dark:bg-stone-900 border-b border-b-gray-300 dark:border-b-0 dark:border-b-gray-700'>
                ...
                <nav id='navBar' className={`lg:flex flex lg:static absolute text-lg lg:flex-row sm:mx-auto h-[300px] md:h-fit w-[250px]  text-center md:w-[60%] md:z-auto  md:justify-between  transition-all duration-500 ease-in md:opacity-100 opacity-0  ${open ? 'flex flex-col bg-wheat dark:bg-stone-900  p-4 rounded leading-[50px] right-0 my-auto z-10 top-20 opacity-100' : 'flex-col sticky top-[-500px]  '}`} style={{fontFamily: 'cursive'}}>
